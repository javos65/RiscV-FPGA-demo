...
//
// Verific Verilog Description of module Mycpu
//
module Mycpu (led_o, rstn_i, rxd_i, scl0, sda0, txd_o);
    inout [7:0]led_o;
    input rstn_i;
    input rxd_i;
    inout scl0;
    ...
    wire cpu0_inst_AHBL_M0_INSTR_interconnect_HMASTLOCK, cpu0_inst_AHBL_M0_INSTR_interconnect_HREADYOUT, 
        ...
        i2c0_inst_INTR_interconnect_IRQ, equation_module0_inst_O_net, osc0_inst_hf_clk_out_o_net, 
    ...
    defparam apb0_inst.S0_BASE_ADDR = 32'h00008800;
    ...
    defparam apb0_inst.S2_BASE_ADDR = 32'h00008400;
    cpu0 cpu0_inst (.ahbl_m_data_haddr_o({cpu0_inst_AHBL_M1_DATA_interconnect_HADDR}), 
         ...
         .irq1_i(gpio0_inst_INTR_interconnect_IRQ), .irq2_i(i2c0_inst_INTR_interconnect_IRQ), 
    ...
    i2c0 i2c0_inst (.apb_paddr_i({apb0_inst_APB_M02_interconnect_PADDR[5:0]}), 
         .apb_prdata_o({apb0_inst_APB_M02_interconnect_PRDATA}), .apb_pwdata_i({apb0_inst_APB_M02_interconnect_PWDATA}), 
         .apb_penable_i(apb0_inst_APB_M02_interconnect_PENABLE), .apb_pready_o(apb0_inst_APB_M02_interconnect_PREADY), 
         .apb_psel_i(apb0_inst_APB_M02_interconnect_PSELx), .apb_pslverr_o(apb0_inst_APB_M02_interconnect_PSLVERR), 
         .apb_pwrite_i(apb0_inst_APB_M02_interconnect_PWRITE), .clk_i(pll0_inst_clkos_o_net), 
         .int_o(i2c0_inst_INTR_interconnect_IRQ), .rst_n_i(cpu0_inst_system_resetn_o_net), 
         .scl_io(scl0), .sda_io(sda0));
